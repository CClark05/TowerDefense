...
{
    AnimationHandle Play(AnimationClip clip, Transform transform, AnimPlayMode mode = AnimPlayMode.Auto,
        float? duration = null, AnimArgs args = null, object owner = null, int layer = 0);

    public AnimationHandle Play(AnimationClip clip, Transform transform, AnimArgs args,
